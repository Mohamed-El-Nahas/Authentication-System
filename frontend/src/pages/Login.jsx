...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-cyan-950'>
      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <button className='w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-900 text-white font-medium'>{state}</button>
        </form>
        {state === 'Sign Up' ? (
